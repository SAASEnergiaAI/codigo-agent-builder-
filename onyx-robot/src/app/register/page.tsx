    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-onyx-muted">Start building with AI today</p>
        </div>
        ...
        <div className="glass rounded-2xl p-8">
          <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
            ...
            <label className="flex items-start gap-2 text-xs text-onyx-muted cursor-pointer">
              <input type="checkbox" className="mt-0.5 rounded border-onyx-border accent-onyx-purple" />
              <span>
                I agree to the{" "}
                <Link href="#" className="text-onyx-purple">Terms of Service</Link>
                {" "}and{" "}
                <Link href="#" className="text-onyx-purple">Privacy Policy</Link>
              </span>
            </label>
            <button
              type="submit"
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-onyx-dark px-3 text-onyx-muted">or sign up with</span>
              </div>
            </div>
        ...
        <p className="text-center text-sm text-onyx-muted mt-6">
          ...
          <Link href="/login" className="text-onyx-purple hover:text-onyx-purple-light">
            Sign in
          </Link>
        </p>
      </motion.div>
